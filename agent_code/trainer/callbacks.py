...
# print('trainer_agent running from ',os.getcwd())
path = 'model/game/'
...
def act(self, game_state):
    ...
    if len(self.record) == 11:
        np.savetxt(f'{path}score_card_{self.round-1}_trainer.csv', self.record, delimiter=',')
    ...
    while len(action_ideas) > 0:
        ...
        if a in valid_actions:
            ...
            # check if game_state['field'] update for destroyed crates
            self.logger.info(f'\n{game_state["field"]}\n ACTION: {a}')
